...
3. Heat Map — Pattern intensity across combined variables (e.g., time, season, or weather)
4. Moving Average — Smoothed trends over time using rolling calculations
